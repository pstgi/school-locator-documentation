...
## ver.3.23.0 (2026-07-07) `includes new widget version`

- Image files for map pins are replaced with embedded pins. The `images-root-url` parameter is no longer used and there is no more `images` sub-folder in `dist`.

## ver.3.22.3 (2026-07-02)

- Fixed issue when Study Area contains only invisible grades.

## ver.3.22.2 (2026-07-01)

- Added support for bulk address parsing in chunks.

## ver.3.22.1 (2026-06-16) `includes new widget version`

- Added separators between messages for schools.
...
- Improved performance of Bulk Parsing of addresses.
